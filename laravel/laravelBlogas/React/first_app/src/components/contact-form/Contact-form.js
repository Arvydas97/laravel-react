                ...
                <div className="contact-form">
                    <div className="container">
                        <div className="section-header">
                            ...
                            <span>Contact</span>
                            <p className="section-subtitle">Lorem ipsum dolor sit amet, consectetur adipisicing
                                elit. Dignissimos debitis.</p>
                        </div>
                        <div className="row">
                                            ...
                                            <div className="col-md-12">
                                                <div className="form-group">
                                                    <input type="text" placeholder="Subject" id="msg_subject"
                                                           ...
                                                           data-error="Please enter your subject"></input>
                                                    <div className="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <div className="col-md-12">
                                                ...
                                                <div className="submit-button">
                                                    <button className="btn btn-common btn-effect" id="submit"
                                ...
                                <div className="contact-deatils">
                                    ...
                                    <div className="contact-info_area">
                                        ...
                                        <ul className="footer-social">
                                            ...
                                            <li><a className="linkedin" href="#"><i
                                                className="lni-linkedin-fill"></i></a></li>
                                            <li><a className="google-plus" href="#"><i
                                                className="lni-google-plus"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
